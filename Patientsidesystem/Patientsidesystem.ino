...
<body>
    ...
    <div class="dashboard">
        <div class="part1">
            ...
            <div class="card">
                ...
                <h2>
                    <span id="EstimatedTimeValue" style="color:rgb(241, 75, 9)">0 </span>
                    <span style="color:rgb(241, 75, 9)">Min</span>
                </h2>
            </div>
        ...
        <div class="part2">
            <div class="card">
                <div
                    ...
                    Drops Count </div>
                <h2>
                    <div style="color:rgb(241, 75, 9)" id="DropCValue">0</div>
                    <div style="color:rgb(241, 75, 9)" > Drops/Min</div>
                </h2>
            </div>
            <div class="card">
                <div
                    ...
                    Flow Rate </div>
                <h2>
                    <div id="FlowRateValue" style="color:rgb(241, 75, 9)">0</div>
                    <div style="color:rgb(241, 75, 9)"> ml/min</div>
                </h2>
            </div>
            <div class="card">
                <div
                    ...
                    Drop Factor </div>
                <h2>
                    <div id="DropFactorValue" style="color:rgb(241, 75, 9)">0</div>
                    <div style="color:rgb(241, 75, 9)"> drops/ml</div>
                </h2>
            </div>
            <div class="card">
                <div
                    ...
                    Infusion Time: </div>
                <h2>
                    <div id="InfusionTimeValue" style="color:rgb(241, 75, 9)">0</div>
                    <div style="color:rgb(241, 75, 9)">Min</div>
                </h2>
            </div>
    ...
    <script>
        ...
        function getDropCValue() {
            var valRequest = new XMLHttpRequest();
            valRequest.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    document.getElementById("DropCValue").innerHTML =
                        this.responseText;
                }
            };
            valRequest.open("GET", "readDropCValue", true);
            valRequest.send();
        }
        //-------------------------------------------------------
        function help() {
...
RF24 radio(4, 2);  // declaring CE and CSN pins
...
void servorot(int i){
      if (i>=50) {
      myservo.write(10); //open
      delay(50);
    } else {
      myservo.write(175); //close
      delay(50);
    }
...
void setup() {
  ...
  server.on("/readDropCValue", handlegetDropCValue);
...
{
 String LoadCellData = String(int(i));
...
{
 String TotalVolume = String(int(v));
...
void handlegetDropCValue()
{
 
 String dropValue = String(count);
 server.send(200, "text/plane", dropValue);
}
//============
//Webpage Code
//============